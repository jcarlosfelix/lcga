package lifecycle_ga;			   // Change to be apart of relevant package
...
public class BenchFunction {
    ...
    private String input_data;	   // Directory location for the input_data folder
     ...
     * @param input_data	Directory location for the input_data folder
     * @param n        		Number of dimensions
     * @param funcNum  		Function this object is representing
     */
    public BenchFunction (String input_data, int n, int funcNum) {
    ...
    public BenchFunction (String input_data, int n, double lower_bounds, double upper_bounds, int funcNum) {
        // Initializing global variables
    	this.input_data = input_data;
        this.n       = n;
        this.funcNum = funcNum;
        this.compNum = 10;
        this.min     = lower_bounds;    //----Default: -100.0
        this.max     = upper_bounds;    //----Default: 100.0
        this.range   = Math.abs(max - min);
    ...
    private void loadData () {
        ...
        switch (funcNum) {
        	case 0: // Shifted and Rotated Sum of Different Power Function
    ...
    private void loadRotationData () {
        ...
        try {
            ...
            File file = new File (input_data + "/M_" + funcNum + "_D" + n + ".txt");
    ...
    private void loadShiftData () {
        ...
        try {
            ...
            File file = new File (input_data + "/shift_data_" + funcNum + ".txt");
    ...
    private void loadShuffleData () {
        ...
        try {
            ...
            File file = new File (input_data + "/shuffle_data_" + funcNum + "_D" + n + ".txt");
    ...
    /**
     * F0: Shifted and Rotated Sum of Different Power Function.
     * @param x       Decision vector
     * @param nx      Number of dimensions
     * @param s_flag  Function shift flag
     * @param r_flag  Function rotation flag
     ...
     * @return        double: function value given
     */
    private double sumDiffPowFunc (double [] x, int nx, int s_flag, int r_flag, int funcPos) {
        double result = 0.0; 
        shiftRotateFunc(x, z, 1.0, s_flag, r_flag, funcPos); // Shift & rotate
        for (int i = 0; i < nx; i++) {
        	double xi = z[i];
        	double newv = Math.pow((Math.abs(xi)), (i+1));
        	result += newv;
        }
        return result;
    } // sumDiffPowFunc    
    ...
    */
    ...
    public String getName () {
        switch (funcNum) {
            case 0:  return "Shifted and Rotated Sum of Different Power Function";   
